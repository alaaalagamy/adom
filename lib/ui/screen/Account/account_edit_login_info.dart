...
class AccountEditLoginInfo extends StatefulWidget {
  const AccountEditLoginInfo({Key? key}) : super(key: key);

  @override
  State<AccountEditLoginInfo> createState() => _AccountEditLoginInfoState();
}

class _AccountEditLoginInfoState extends State<AccountEditLoginInfo> {
  String errorMessage = "";
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    focusedBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(10.0), borderSide: const BorderSide(color: Colors.grey)),
                                    enabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: Colors.grey.shade400)),
                                    errorBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(10.0), borderSide: const BorderSide(color: Colors.red, width: 2.0)),
